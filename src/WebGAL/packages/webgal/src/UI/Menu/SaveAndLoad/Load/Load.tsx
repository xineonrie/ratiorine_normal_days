...
import savingSlot from '../material/saving-slot.png';
import numberIcon from '../material/number-icon.png';
      ...
      saveElementContent = (
        <>   
          <div className={styles.Save_Load_content_miniRen}>
            <div  className={styles.Save_Load_content_number} >
              <div className={styles.Save_Load_content_element_top_index + ' ' + styles.Load_content_elememt_top_index}>
              {saveData.index}
              </div>
              <img src={numberIcon} className={styles.Save_Load_content_number_icon} />
            </div>
